...
system("perl iplant.pl < t/list_names.txt > /tmp/iplant_test_output.txt") == 0
    or die("Could not execute iplant.pl: $?");

use File::Compare;
ok(
    compare("/tmp/iplant_test_output.txt", "t/iplant_test_expected.json") == 0,
    "Checking whether iplant.pl can be used to output the correct file information."  
);
