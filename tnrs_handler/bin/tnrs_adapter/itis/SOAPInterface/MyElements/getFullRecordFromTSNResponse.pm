...
package MyElements::getFullRecordFromTSNResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('getFullRecordFromTSNResponse');
...
MyElements::getFullRecordFromTSNResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getFullRecordFromTSNResponse from the namespace http://itis_service.itis.usgs.org.
...
=head2 new
 ...
 my $element = MyElements::getFullRecordFromTSNResponse->new($data);
