...
package MyElements::searchByScientificNameResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('searchByScientificNameResponse');
...
__PACKAGE__->_factory(
    ...
    {
        'return' => 'MyTypes::SvcScientificNameList',
    },
    {
...
MyElements::searchByScientificNameResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
searchByScientificNameResponse from the namespace http://itis_service.itis.usgs.org.
...
=head2 new
 ...
 my $element = MyElements::searchByScientificNameResponse->new($data);
