...
package MyElements::getScientificNameFromTSNResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('getScientificNameFromTSNResponse');
...
__PACKAGE__->_factory(
    ...
    {
        'return' => 'MyTypes::SvcScientificName',
    },
    {
...
MyElements::getScientificNameFromTSNResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getScientificNameFromTSNResponse from the namespace http://itis_service.itis.usgs.org.
...
=head2 new
 ...
 my $element = MyElements::getScientificNameFromTSNResponse->new($data);
